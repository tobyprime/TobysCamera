...
public final class ViewfinderControlsScreen extends Screen {
    ...
    protected void init() {
        ...
        addRenderableWidget(CycleButton.builder(PreviewScreen::resolutionValueLabel, selected)
                .withValues(java.util.stream.IntStream.rangeClosed(1, maximum).boxed().toList())
                .displayOnlyValue()
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        graphics.renderOutline(left, top, panelWidth, PANEL_HEIGHT, 0xE0FFFFFF);
        graphics.drawString(font, title, left + 6, top - 10, 0xFFFFFFFF, true);
