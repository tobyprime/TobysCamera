...
public final class VideoPreviewScreen extends Screen {
    ...
    @Override public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
        ...
        if (!previewReady) {
            graphics.centeredText(font, Component.translatable("tobyscamera.video_preview.processing"), width / 2, height / 2, 0xFFFFFFFF);
            ...
            graphics.centeredText(font, "Frames %d-%d · %d FPS · %dx%d maps".formatted(startFrame, endFrame, fps, layout().gridWidth(), layout().gridHeight()), width / 2, 20 + drawHeight + 6, 0xFFFFFFFF);
        }
